...
{
    public class IngosBaseContext : DbContext, IUnitOfWork, ITransaction
    {
        #region Initialize
        ...
        public IngosBaseContext(DbContextOptions<IngosBaseContext> options)
            : base(options)
        { }
